        ...
        {projectData.map((data, key) =>{
            return(
                    <div key={key} className= "dark:bg-gray-800 drop-shadow-lg border-2 rounded-2xl p-10 basis-1/3 flex-1 h-90">
                        <new Image className="rounded-2xl w-full h-44 object-cover drop-shadow-xl dark:text-white" src={data.image} alt={data.pr_name} width={'100%'} height={'100%'} layout="responsive"/>
